...
---- CUSTOM KEYMAPS (SUGGESTED BY GEMINI FOR PYTHON) --------
-- Save and run the current Python file with <leader>rp
vim.keymap.set('n', '<leader>rp', function()
  -- Save the file first
  vim.cmd('write')
  -- Get the current file path
  local file = vim.fn.expand('%')
  -- Open a terminal in a bottom split and run python
...
require('lazy').setup({
  ...
  --    }
  ---------------------------------------------------------------
  -- NOTE: Custom plugins installation 
  -- MONOKAI-PRO
  {
